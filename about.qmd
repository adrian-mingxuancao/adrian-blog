...
- **Single-Cell Perturbation & Generative Models**: Predicting transcriptomic responses to drugs, genetic perturbations, and developmental or physical stimuli using diffusion, VAEs, optimal transport, and related approaches
...
- **Multimodal Genomic Analysis**: Integrating diverse data types for comprehensive biological insights
- **GWAS and Beyond**: Advancing beyond statistical associations to mechanistic understanding
